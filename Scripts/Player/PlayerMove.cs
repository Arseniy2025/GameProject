...
public class PlayerMove : MonoBehaviour
{
    ...
    [Header("Player Scale")]
    [SerializeField] private Vector3 playerScale = new Vector3(5, 5, 1); // ‘иксированный размер 5
    ...
    private void Awake()
    {
        ...
        // ”станавливаем фиксированный размер при старте
    ...
    private void Update()
    {
        ...
        //Flip player when moving left-right (только мен€ем знак X, сохран€€ размер)
    ...
    // ћетод дл€ принудительной установки размера (можно вызвать из других скриптов)
